...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(5, "Giáp sắt", 4, 2, 2, "[Thảo nguyên] Tương truyền nếu thu thập đủ trang bị, Phù Đổng Thiên Vương sẽ tái thế", Resources.Load<Sprite>("Lac_Viet_Deck/Giap_sat"), 0, 0, 0, 0, false, 0, "Common", ElementType.Earth));
        ...
        cardList.Add(new Card(13, "Ngựa sắt", 5, 5, 5, "[Thảo nguyên] Tương truyền nếu thu thập đủ trang bị, Phù Đổng Thiên Vương sẽ tái thế", Resources.Load<Sprite>("Lac_Viet_Deck/Ngua_sat"), 0, 0, 0, 0, false, 0, "Rare", ElementType.Earth));
        cardList.Add(new Card(14, "Roi sắt", 4, 4, 4, "[Thảo nguyên] Tương truyền nếu thu thập đủ trang bị, Phù Đổng Thiên Vương sẽ tái thế", Resources.Load<Sprite>("Lac_Viet_Deck/Roi_sat"), 0, 0, 0, 0, false, 0, "Rare", ElementType.Earth));
